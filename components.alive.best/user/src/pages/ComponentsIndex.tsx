...
const ComponentsIndex = () => {
  const templates = [
    ...
    { name: 'SaaS Landing', route: 'https://one.alive.best/#features', external: true, inProgress: true },
    { name: 'Design/Architecture studio', route: 'https://demo.alive.best', external: true, inProgress: true },
    { name: 'Speaker/Business Event', route: 'https://four.alive.best', external: true, done: true },
    { name: 'Music Event', route: 'https://kapper.alive.best', external: true, inProgress: true },
    { name: 'Startup Waitlist', route: 'https://six.alive.best', external: true, inProgress: true },
