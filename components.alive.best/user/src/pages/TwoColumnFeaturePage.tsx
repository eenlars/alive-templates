...
const TwoColumnFeaturePage = () => {
  const { template, isLoading, error } = useTemplateLoader('two-column-feature');
  ...
  return (
    <div style={{
      ...
      <PromptModal
        isOpen={showPrompt}
        title="Two Column Feature Prompt"
        content={template || ''}
        isLoading={isLoading}
        error={error}
        onClose={closeModal}
...
export default TwoColumnFeaturePage;
