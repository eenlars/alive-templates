const ContactForm = () => {
  ...
  const EmailIcon = () => (
    ...
    >
      <defs>
        <clipPath id="email-clip" clipPathUnits="userSpaceOnUse">
          <path d="M0 512h512V0H0Z" data-original="#000000"></path>
        </clipPath>
      </defs>
      <g clipPath="url(#email-clip)" transform="matrix(1.33 0 0 -1.33 0 682.667)">
        <path
          fill="none"
          strokeMiterlimit="10"
          strokeWidth="40"
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-white p-4">
      <form className="max-w-4xl w-full">
        ...
        <button
          type="button"
          className="mt-12 px-4 py-2 w-full text-[15px] font-medium bg-slate-900 text-white hover:bg-slate-800 rounded-sm cursor-pointer transition-colors"
        >
          Register
        </button>
      </form>
