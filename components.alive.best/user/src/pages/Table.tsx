const Table = () => {
  ...
  const EditIcon = () => (
    <svg
      ...
      className="w-5 h-5 fill-blue-500 hover:fill-blue-700 transition-colors"
  ...
  const DeleteIcon = () => (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      className="w-5 h-5 fill-red-500 hover:fill-red-700 transition-colors"
      viewBox="0 0 24 24"
    >
