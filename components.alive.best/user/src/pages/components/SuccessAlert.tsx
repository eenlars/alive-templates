...
const SuccessAlert = () => {
  ...
  const componentPrompt = `Create a success alert box component:
...
The component should be self-contained and require no external context to recreate.`
  ...
  const SuccessAlertComponent = () => (
    <div className="rounded-md border border-green-500 bg-green-50 p-4 shadow-sm" role="alert">
      <div className="flex items-start gap-4">
        ...
        <div className="flex-1">
          ...
          <p className="mt-0.5 text-sm text-green-700">
            Your changes have been saved successfully. The update will be reflected across all pages within the next few moments.
          </p>
        </div>
      </div>
    </div>
