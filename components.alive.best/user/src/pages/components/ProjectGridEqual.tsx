...
const ProjectGridEqual = () => {
  const { template, isLoading, error } = useTemplateLoader('project-grid-equal')
  ...
  return (
    <div className="min-h-screen bg-background p-8 flex flex-col">
      <div className="max-w-5xl mx-auto w-full flex-1 flex flex-col">
        ...
        <PromptModal
          isOpen={showPrompt}
          title="Project Grid Equal Prompt"
          content={template || ''}
          isLoading={isLoading}
          error={error}
          onClose={closeModal}
        ...
        <div className="w-full grid grid-cols-2 md:grid-cols-3 gap-4">
          {projects.map((project, idx) => (
            <a
              key={idx}
              href="#"
              className="group relative rounded-[--radius] overflow-hidden aspect-square focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2"
...
export default ProjectGridEqual
